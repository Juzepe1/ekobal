...
import { useTimerCount } from "../../hooks/use_timer";

export class TimerStartStopField extends Component {
    static props = {
        ...standardFieldProps,
    };
    static template = "timer.count.TimerStartStopField";

    setup() {
        super.setup(...arguments);
        this.timerReactive = useState(useTimerCount());
...
export const timerStartStopField = {
    component: TimerStartStopField,
    fieldDependencies: [ { name: "timer_pause", type: "datetime" } ],
};

registry.category("fields").add("timer_start_stop_field", timerStartStopField);
